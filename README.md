...
1. Remove todas as tabelas e campos do extrator.
2. Salva a extração atual em um modelo, no formato json.
3. Carrega um modelo previamente salvo.
4. Exporta o extrator em um arquivo txt.
5. Encerra o script.
